...
export const StorefrontHeader: React.FC<StorefrontHeaderProps> = ({
  ...
  return (
    <header className="w-full font-sans sticky top-0 z-40 shadow-md">
      {/* Topmost Utility Bar */}
      <div className="bg-[#133e1b] text-white text-xs py-2 px-4 sm:px-8 flex flex-wrap items-center justify-between gap-2 border-b border-green-800">
      ...
      <div className="bg-white py-3.5 px-4 sm:px-8 flex items-center justify-between border-b border-gray-100">
        {/* Logos & Institution Name */}
        <div 
          onClick={onGoHome}
          className="flex items-center gap-3 sm:gap-4 cursor-pointer group"
        >
          {/* Emblem ICAR / KVK Green Leaf Logo */}
          ...
          <div>
            ...
            <h1 className="text-lg sm:text-xl font-extrabold text-[#133e1b] leading-tight flex items-center gap-1.5">
              Krishi Vigyan Kendra
              <span className="text-[#f37021] text-xs font-semibold px-2 py-0.5 rounded bg-orange-50 border border-orange-200 hidden sm:inline-block">
                E-Store
              </span>
            </h1>
      ...
      {/* Main Navigation Bar */}
      <nav className="bg-[#1e7e34] text-white text-xs sm:text-sm font-semibold px-4 sm:px-8 py-2.5 flex items-center justify-between overflow-x-auto whitespace-nowrap border-t border-emerald-600">
        <div className="flex items-center gap-6 sm:gap-8">
          ...
          <a href="#products-section" className="hover:text-amber-300 transition-colors flex items-center gap-1">
            ...
            <span className="bg-[#f37021] text-[9px] text-white px-1.5 py-0.2 rounded-full uppercase">Featured</span>
          </a>
